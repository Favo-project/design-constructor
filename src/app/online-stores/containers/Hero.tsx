        ...
        <header className="relative overflow-hidden py-20">
            <div className="container m-auto max-w-7xl">
                ...
                <div className="relative z-10 flex flex-col items-center m-auto px-4 mb-12">
                    <h1 className="max-w-sm mt-6 mb-8 text-center lg:text-5xl md:text-3xl text-2xl font-bold leading-snug font-sans text-slate-700 tracking-wide">OPEN YOUR ONLINE STORE</h1>
