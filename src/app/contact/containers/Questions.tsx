                            ...
                            <Tab
                                className={({ selected }) =>
                                    classNames(
                                        ...
                                        'outline-none',
                                        selected
                                            ? 'shadow-[inset_0_0_0_2px_#bdc8d9] hover:shadow-[inset_0_0_0_2px_#bdc8d9] after:block after:w-4 after:h-4 after:absolute after:right-2 after:bottom-2 after:rounded-full after:bg-[#2b8265]'
