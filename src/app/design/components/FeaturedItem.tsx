        ...
        <>
            {
                isProductFeatured() && isColorFeatured() ? (
                    <button className='absolute bottom-5 left-[35%] px-3 py-2 text-sm font-semibold rounded-lg border-2 shadow-lg bg-white border-slate-100 text-indigo-500 hover:border-slate-300 transition-all flex items-center '>
